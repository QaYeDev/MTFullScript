...
__all__ = [
    'IPictureDisp', 'FONTUNDERSCORE', 'OLE_TRISTATE',
    'IFontEventsDisp', 'OLE_HANDLE', 'Font', 'Picture',
    'OLE_YSIZE_HIMETRIC', 'OLE_COLOR', 'Checked', 'Unchecked',
    'Default', 'FONTBOLD', 'IFontDisp', 'VgaColor',
    'OLE_XSIZE_PIXELS', 'OLE_XSIZE_CONTAINER', 'OLE_YPOS_PIXELS',
    'Gray', 'FONTSTRIKETHROUGH', 'Monochrome', 'OLE_YPOS_HIMETRIC',
    'FONTITALIC', 'OLE_OPTEXCLUSIVE', 'StdFont', 'OLE_YSIZE_PIXELS',
    'OLE_ENABLEDEFAULTBOOL', 'FONTSIZE', 'OLE_XPOS_PIXELS',
    'FONTNAME', 'OLE_CANCELBOOL', 'StdPicture', 'Color',
    'LoadPictureConstants', 'OLE_XSIZE_HIMETRIC', 'IPicture', 'IFont',
    'OLE_YSIZE_CONTAINER', 'OLE_XPOS_CONTAINER', 'OLE_YPOS_CONTAINER',
    'FontEvents', 'OLE_XPOS_HIMETRIC'
]

_check_version('1.2.0', 1622894692.653069)
