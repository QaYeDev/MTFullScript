...
__all__ = [
    'SynchronizedInputType_LeftMouseUp', 'IUIAutomationAndCondition',
    'TextUnit_Page', 'TextPatternRangeEndpoint_Start',
    'UIA_IsPeripheralPropertyId',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_AccessKeyPropertyId', 'IUIAutomationProxyFactoryEntry',
    'UIA_IsTextPatternAvailablePropertyId', 'UIA_WindowPatternId',
    'UIA_AnnotationPatternId', 'UIA_OutlineColorPropertyId',
    'UIA_TreeItemControlTypeId', 'IUIAutomationDockPattern',
    'UIA_SayAsInterpretAsAttributeId', 'UIA_SpinnerControlTypeId',
    'UIA_MultipleViewPatternId', 'UIA_AriaRolePropertyId',
    'UIA_CustomNavigationPatternId', 'UIA_HeadingLevelPropertyId',
    'UIA_ControllerForPropertyId',
    'UIA_StrikethroughStyleAttributeId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_TextChildPatternId', 'Off', 'UIA_ValueIsReadOnlyPropertyId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_IsKeyboardFocusablePropertyId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_OutlineThicknessPropertyId', 'CUIAutomation8',
    'HeadingLevel8', 'AnnotationType_Footer', 'UIA_TreeControlTypeId',
    'UIA_RangeValueSmallChangePropertyId',
    'UIA_DescribedByPropertyId', 'IUIAutomationOrCondition',
    'UIA_FlowsFromPropertyId', 'IUIAutomationValuePattern',
    'UIA_CaretPositionAttributeId', 'UIA_LayoutInvalidatedEventId',
    'UIA_IsActiveAttributeId', 'CoalesceEventsOptions',
    ...
    'UIA_ButtonControlTypeId', 'UIA_DragIsGrabbedPropertyId',
    'ProviderOptions', 'UIA_RangeValueMaximumPropertyId',
    'UIA_IsValuePatternAvailablePropertyId', 'IUIAutomationTextRange',
    'UIA_Selection_InvalidatedEventId',
    'UIA_Transform2ZoomMinimumPropertyId', 'IUIAutomation',
    'UIA_SelectionItemIsSelectedPropertyId', 'UIA_TabsAttributeId',
    'UIA_Selection2ItemCountPropertyId', 'UiaChangeInfo',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_CalendarControlTypeId', 'UIA_IsEnabledPropertyId',
    'UIA_AcceleratorKeyPropertyId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_LiveSettingPropertyId', 'TextUnit_Paragraph',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'AutomationElementMode', 'TextEditChangeType_Composition',
    'StyleId_Emphasis', 'UIA_ScrollHorizontallyScrollablePropertyId',
    'AnnotationType_Unknown',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_TextControlTypeId', 'UIA_PositionInSetPropertyId',
    'UIA_MenuModeStartEventId', 'UIA_AutomationIdPropertyId',
    'UIA_VirtualizedItemPatternId', 'IUIAutomationTreeWalker',
    'UIA_TextFlowDirectionsAttributeId', 'UIA_CultureAttributeId',
    'IUIAutomationTextEditPattern', 'NotificationKind',
    'UIA_DockPatternId', 'IUIAutomationExpandCollapsePattern',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'NotificationProcessing_MostRecent', 'StyleId_Normal',
    'UIA_StylesFillColorPropertyId',
    'UIA_Transform2CanZoomPropertyId', 'UIA_ItemTypePropertyId',
    'DockPosition_Left', 'UIA_FullDescriptionPropertyId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_SpreadsheetItemFormulaPropertyId', 'DockPosition_Right',
    'IUIAutomationEventHandler', 'UIA_HeaderControlTypeId',
    'IUIAutomationNotificationEventHandler',
    'UIA_StrikethroughColorAttributeId', 'UIA_IsReadOnlyAttributeId',
    'ConnectionRecoveryBehaviorOptions', 'UIA_ValuePatternId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_IsDataValidForFormPropertyId',
    'NotificationProcessing_ImportantAll', 'UIA_FontSizeAttributeId',
    'IUIAutomation3', 'UIA_Invoke_InvokedEventId',
    'UIA_SeparatorControlTypeId', 'UIA_AsyncContentLoadedEventId',
    'UIA_CapStyleAttributeId',
    'UIA_IsStylesPatternAvailablePropertyId', 'HeadingLevel2',
    'AnnotationType_FormatChange', 'HeadingLevel1',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_ToggleToggleStatePropertyId', 'UIA_TabControlTypeId',
    'UIA_TabItemControlTypeId', 'UIA_ImageControlTypeId',
    'UIA_TableControlTypeId', 'TextUnit_Word',
    'UIA_FontWeightAttributeId', 'IUIAutomation2',
    'UIA_ControlTypePropertyId', 'UIA_ScrollPatternId',
    'StyleId_Heading8', 'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_LegacyIAccessibleRolePropertyId',
    'UIA_ProgressBarControlTypeId', 'HeadingLevel5',
    'AnnotationType_CircularReferenceError',
    'IUIAutomationElementArray', 'UIA_OverlineColorAttributeId',
    'IUIAutomationTextRange3', 'UIA_InputReachedOtherElementEventId',
    'HeadingLevel6', 'UIA_RotationPropertyId',
    'UIA_SayAsInterpretAsMetadataId', 'UIA_SizePropertyId',
    'IUIAutomationSynchronizedInputPattern', 'WindowVisualState',
    'UIA_SliderControlTypeId', 'StyleId_Heading9',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'AnnotationType_Mathematics',
    'IUIAutomationStructureChangedEventHandler',
    'AnnotationType_UnsyncedChange', 'UIA_NamePropertyId',
    'WindowVisualState_Minimized',
    'TreeTraversalOptions_LastToFirstOrder',
    'UIA_AnnotationTargetPropertyId', 'IUIAutomation5',
    'UIA_IsTransformPatternAvailablePropertyId', 'TreeScope_Element',
    'AnnotationType_EditingLockedChange',
    'ProviderOptions_UseComThreading',
    'UIA_IsInvokePatternAvailablePropertyId', 'Polite',
    'UIA_BulletStyleAttributeId',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_ToolTipClosedEventId', 'UIA_GridRowCountPropertyId',
    'UIA_ItemStatusPropertyId', 'IUIAutomationTransformPattern',
    'UIA_Window_WindowOpenedEventId',
    'NotificationProcessing_ImportantMostRecent',
    'NavigateDirection_PreviousSibling',
    'IUIAutomationDropTargetPattern', 'TreeScope_Children',
    'UIA_RangeValueMinimumPropertyId', 'IUIAutomationElement5',
    'StructureChangeType', 'UIA_ScrollItemPatternId',
    'UIA_IsControlElementPropertyId', 'HeadingLevel_None',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId', 'Assertive',
    'UIA_AfterParagraphSpacingAttributeId', 'OrientationType_None',
    'UIA_IsWindowPatternAvailablePropertyId', 'IUIAutomation6',
    'ScrollAmount_SmallDecrement', 'ZoomUnit_LargeIncrement',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_LineSpacingAttributeId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'SupportedTextSelection_None', 'UIA_StylesStyleNamePropertyId',
    'TreeTraversalOptions', 'UIA_ChangesEventId',
    'TextUnit_Character', 'UIA_IsDockPatternAvailablePropertyId',
    'SynchronizedInputType_RightMouseUp',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_ScrollBarControlTypeId', 'TextEditChangeType_None',
    'SupportedTextSelection_Single', 'UIA_SelectionPatternId',
    'NotificationProcessing',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_LegacyIAccessibleValuePropertyId',
    'IUIAutomationCustomNavigationPattern', 'TreeScope',
    'UIA_MenuClosedEventId', 'UIA_ActiveTextPositionChangedEventId',
    'UIA_LandmarkTypePropertyId', 'UIA_CulturePropertyId',
    'SupportedTextSelection_Multiple',
    'UIA_LocalizedControlTypePropertyId',
    'UIA_NativeWindowHandlePropertyId', 'UIA_EditControlTypeId',
    'UIA_DragPatternId', 'AnnotationType_Author', 'TextUnit_Line',
    'AnnotationType_Header', 'UIA_MenuItemControlTypeId',
    'IUIAutomationBoolCondition', 'UIA_Transform2ZoomLevelPropertyId',
    'UIA_DataGridControlTypeId', 'UIA_PaneControlTypeId',
    'UIA_IsContentElementPropertyId', 'UIA_TablePatternId',
    'IUIAutomationChangesEventHandler', 'IUIAutomation4',
    'UIA_InvokePatternId', 'UIA_ClickablePointPropertyId',
    'IUIAutomationRangeValuePattern', 'UIA_FontNameAttributeId',
    'UIA_BoundingRectanglePropertyId',
    'UIA_Window_WindowClosedEventId', 'TextUnit',
    'UIA_StylesStyleIdPropertyId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'PropertyConditionFlags_None', 'IUIAutomationMultipleViewPattern',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_DocumentControlTypeId', 'UIA_TableRowHeadersPropertyId',
    'AnnotationType_ConflictingChange', 'StyleId_Subtitle',
    'UIA_IndentationFirstLineAttributeId', 'UIA_ToolTipControlTypeId',
    'WindowInteractionState_Closing', 'UIA_WindowIsModalPropertyId',
    'ZoomUnit', 'RowOrColumnMajor_Indeterminate', 'HeadingLevel7',
    'UIA_ListItemControlTypeId', 'ExpandCollapseState_LeafNode',
    'UIA_GridItemContainingGridPropertyId',
    'UIA_InputDiscardedEventId', 'UIA_SizeOfSetPropertyId',
    'UIA_Transform2ZoomMaximumPropertyId',
    'IUIAutomationObjectModelPattern',
    'TreeTraversalOptions_PostOrder', 'IUIAutomationNotCondition',
    'UIA_IsSubscriptAttributeId', 'UIA_FormLandmarkTypeId',
    'UIA_CustomControlTypeId', 'PropertyConditionFlags',
    'UIA_ToolBarControlTypeId', 'RowOrColumnMajor_RowMajor',
    'UIA_ProcessIdPropertyId', 'UIA_TransformCanResizePropertyId',
    'AutomationElementMode_Full',
    'UIA_LocalizedLandmarkTypePropertyId',
    'AnnotationType_DataValidationError',
    'IUIAutomationLegacyIAccessiblePattern', 'SupportedTextSelection',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_AnimationStyleAttributeId', 'IUIAutomationTableItemPattern',
    'IUIAutomationSpreadsheetItemPattern', 'TreeScope_Parent',
    'ScrollAmount_LargeIncrement',
    'PropertyConditionFlags_IgnoreCase', 'HeadingLevel9',
    'NavigateDirection', 'UIA_HasKeyboardFocusPropertyId',
    'UIA_LevelPropertyId', 'NavigateDirection_FirstChild',
    'ZoomUnit_LargeDecrement', 'ProviderOptions_OverrideProvider',
    'NavigateDirection_LastChild', 'TextUnit_Document',
    'UIA_RadioButtonControlTypeId', 'UIA_TableItemPatternId',
    'IUIAutomationSelectionItemPattern',
    'UIA_GridItemColumnPropertyId', 'UIA_GridColumnCountPropertyId',
    'OrientationType_Horizontal', 'WindowVisualState_Maximized',
    'SynchronizedInputType', 'HeadingLevel4',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'AnnotationType_Endnote', 'UIA_CenterPointPropertyId',
    'RowOrColumnMajor_ColumnMajor',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_AnnotationTypesPropertyId', 'IUIAutomationTextPattern2',
    'IUIAutomationTablePattern', 'UIA_MarginTopAttributeId',
    'WindowVisualState_Normal', 'AnnotationType_Sensitive',
    ...
    'UIA_VisualEffectsPropertyId', 'IUIAutomationScrollPattern',
    'UIA_SelectionPattern2Id', 'UIA_CheckBoxControlTypeId',
    'IUIAutomationProxyFactoryMapping',
    'IUIAutomationTransformPattern2', 'IUIAutomationTextChildPattern',
    'IUIAutomationTextPattern',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_WindowCanMinimizePropertyId', 'TextPatternRangeEndpoint_End',
    'TreeScope_Ancestors', 'UIA_DropTarget_DroppedEventId',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_OutlineStylesAttributeId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'ProviderOptions_ClientSideProvider',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_LabeledByPropertyId', 'HeadingLevel3', 'TextEditChangeType',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'AnnotationType_Comment',
    'UIA_IsTableItemPatternAvailablePropertyId', 'UIA_TextPatternId',
    'IUIAutomationSelectionPattern', 'IUIAutomationElement3',
    'ExtendedProperty', 'UIA_HelpTextPropertyId',
    'UIA_GridItemPatternId', 'UIA_ProviderDescriptionPropertyId',
    'UIA_OrientationPropertyId',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_IsHiddenAttributeId', 'UIA_AutomationPropertyChangedEventId',
    'UIA_SummaryChangeId', 'UIA_RangeValueIsReadOnlyPropertyId',
    'IUIAutomationCacheRequest',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_StylesExtendedPropertiesPropertyId',
    'UIA_ComboBoxControlTypeId', 'UIA_MenuModeEndEventId',
    'UIA_IsTablePatternAvailablePropertyId',
    'UIA_MenuBarControlTypeId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_RuntimeIdPropertyId', 'NotificationKind_ItemAdded',
    'DockPosition_Top',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'IUIAutomationInvokePattern',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_GroupControlTypeId', 'LiveSetting',
    'NotificationKind_ActionAborted', 'UIA_HeaderItemControlTypeId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_SpreadsheetPatternId', 'UIA_ListControlTypeId',
    'UIA_HyperlinkControlTypeId', 'UIA_SelectionActiveEndAttributeId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'NotificationKind_ActionCompleted',
    'UIA_LegacyIAccessiblePatternId', 'WindowInteractionState',
    'IUIAutomationGridItemPattern',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'AnnotationType_MoveChange', 'UIA_NavigationLandmarkTypeId',
    'UIA_FrameworkIdPropertyId', 'ToggleState',
    'CoalesceEventsOptions_Disabled',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_IndentationTrailingAttributeId', 'StyleId_Heading3',
    'UIA_StylesShapePropertyId', 'UIA_Drag_DragCompleteEventId',
    'StyleId_BulletedList',
    'UIA_AnnotationAnnotationTypeNamePropertyId', 'StyleId_Heading6',
    ...
    'IUIAutomationTogglePattern', 'UIA_IndentationLeadingAttributeId',
    'UIA_AnnotationDateTimePropertyId', 'UIA_ToolTipOpenedEventId',
    'UIA_DockDockPositionPropertyId', 'TreeScope_None',
    'ProviderOptions_ServerSideProvider',
    'UIA_SelectionItemPatternId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_MainLandmarkTypeId', 'UIA_TextEdit_TextChangedEventId',
    'ScrollAmount_SmallIncrement', 'ZoomUnit_SmallDecrement',
    'UIA_LinkAttributeId', 'UIA_SearchLandmarkTypeId',
    'AnnotationType_SpellingError', 'UIA_ThumbControlTypeId',
    'UIA_ItemContainerPatternId', 'UIA_Drag_DragCancelEventId',
    'IUIAutomationElement7', 'TreeScope_Descendants',
    'UIA_SynchronizedInputPatternId', 'AnnotationType_Highlighted',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_BackgroundColorAttributeId', 'DockPosition_None',
    'IUIAutomationElement9', 'UIA_SemanticZoomControlTypeId',
    'TextPatternRangeEndpoint', 'UIA_TransformCanRotatePropertyId',
    'ProviderOptions_ProviderOwnsSetFocus',
    'IUIAutomationAnnotationPattern',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_InputReachedTargetEventId', 'IUIAutomationWindowPattern',
    'ToggleState_Off', 'UIA_DataItemControlTypeId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_StylesFillPatternColorPropertyId',
    'UIA_IsTextPattern2AvailablePropertyId', 'IUIAutomationElement8',
    'UIA_TextPattern2Id', 'UIA_DropTarget_DragLeaveEventId',
    'ProviderOptions_HasNativeIAccessible',
    'AnnotationType_ExternalChange',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_ForegroundColorAttributeId', 'ExpandCollapseState',
    'UIA_Text_TextChangedEventId',
    'UIA_ScrollVerticalViewSizePropertyId', 'ZoomUnit_SmallIncrement',
    'UIA_AppBarControlTypeId', 'DockPosition_Fill',
    'UIA_FlowsToPropertyId', 'NotificationKind_Other',
    'UIA_FillColorPropertyId', 'ExpandCollapseState_Collapsed',
    'UIA_TableRowOrColumnMajorPropertyId', 'UIA_DropTargetPatternId',
    'IUIAutomationTextRange2', 'UIA_AnnotationAuthorPropertyId',
    'UIA_RangeValuePatternId', 'NotificationProcessing_All',
    'UIA_DragGrabbedItemsPropertyId',
    'SynchronizedInputType_LeftMouseDown',
    'SynchronizedInputType_RightMouseDown',
    'IUIAutomationGridPattern', 'UIA_RangeValueValuePropertyId',
    'StyleId_Heading5', 'UIA_IsSuperscriptAttributeId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_ObjectModelPatternId', 'UIA_TransformCanMovePropertyId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'UIA_DragDropEffectPropertyId', 'IUIAutomationTextRangeArray',
    'UIA_SystemAlertEventId', 'StructureChangeType_ChildAdded',
    'StyleId_Heading2', 'StyleId_Title', 'TreeScope_Subtree',
    'StyleId_Heading1', 'UIA_CaretBidiModeAttributeId',
    'AnnotationType_GrammarError', 'IRawElementProviderSimple',
    'IAccessible', 'UIA_IsItalicAttributeId',
    'IUIAutomationSpreadsheetPattern', 'IUIAutomationCondition',
    'UIA_IsDialogPropertyId', 'IUIAutomationFocusChangedEventHandler',
    'UIA_UnderlineColorAttributeId', 'AnnotationType_TrackChanges',
    'UIA_Drag_DragStartEventId',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'UIA_LiveRegionChangedEventId', 'AnnotationType_DeletionChange',
    'StyleId_Heading4', 'PropertyConditionFlags_MatchSubstring',
    ...
    'UIA_MarginBottomAttributeId', 'UIA_StatusBarControlTypeId',
    'UIA_FillTypePropertyId', 'IUIAutomationEventHandlerGroup',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'ScrollAmount_LargeDecrement', 'UIA_AnnotationObjectsPropertyId',
    'UIA_CustomLandmarkTypeId', 'ScrollAmount',
    'NavigateDirection_Parent', 'UIA_TransformPatternId',
    ...
    'UIA_WindowControlTypeId', 'CUIAutomation',
    'UIA_TitleBarControlTypeId', 'UIA_GridItemRowPropertyId',
    'OrientationType_Vertical',
    'StructureChangeType_ChildrenBulkAdded',
    'IUIAutomationProxyFactory', 'UIA_GridItemRowSpanPropertyId',
    'UIA_IsDragPatternAvailablePropertyId', 'ScrollAmount_NoAmount',
    'IUIAutomationItemContainerPattern',
    'SynchronizedInputType_KeyUp',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'IUIAutomationSelectionPattern2', 'ZoomUnit_NoAmount',
    'AnnotationType_Footnote', 'IUIAutomationElement2',
    ...
    'UIA_AnnotationTypesAttributeId', 'ToggleState_On',
    'UIA_IsRequiredForFormPropertyId', 'UIA_ClassNamePropertyId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'WindowInteractionState_NotResponding', 'UIA_TextEditPatternId',
    'UIA_NotificationEventId', 'UIA_StructureChangedEventId',
    'IUIAutomationDragPattern', 'UIA_StyleIdAttributeId',
    'TextUnit_Format', 'UIA_UnderlineStyleAttributeId',
    'UIA_LegacyIAccessibleStatePropertyId',
    'StructureChangeType_ChildrenInvalidated', 'StyleId_Heading7',
    'IUIAutomationStylesPattern', 'DockPosition', 'RowOrColumnMajor',
    'UIA_WindowIsTopmostPropertyId', 'UIA_IsOffscreenPropertyId',
    'UIA_StyleNameAttributeId', 'StructureChangeType_ChildRemoved',
    'UIA_SpreadsheetItemPatternId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_DragDropEffectsPropertyId', 'IUIAutomationElement',
    'UIA_TransformPattern2Id', 'UIA_MenuControlTypeId',
    ...
    'StructureChangeType_ChildrenReordered', 'StyleId_Custom',
    'UIA_GridPatternId', 'AnnotationType_AdvancedProofingIssue',
    'UIA_OverlineStyleAttributeId', 'UIA_ValueValuePropertyId',
    'UIA_GridItemColumnSpanPropertyId', 'UIA_TogglePatternId',
    'AnnotationType_InsertionChange', 'SynchronizedInputType_KeyDown',
    'UIA_AriaPropertiesPropertyId', 'UIA_ExpandCollapsePatternId',
    'UIA_MarginTrailingAttributeId', 'AutomationElementMode_None',
    'IUIAutomationElement6', 'StyleId_Quote',
    'UIA_MarginLeadingAttributeId', 'DockPosition_Bottom'
]

_check_version('1.2.0', 1671109928.431438)
